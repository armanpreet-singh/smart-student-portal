  ...
  return (
    ...
    >
      <div style={{ maxWidth: "1280px", margin: "0 auto" }} ref={ref}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "80px", alignItems: "center" }} className="grid-2-col">
...
<div className="card" style={{ padding: "28px", display: "flex", alignItems: "center", gap: "22px", marginBottom: "24px" }}>
  ...
  <div>
    <div style={{ fontSize: "24px", fontWeight: 900, color: "#1B3A6B", letterSpacing: "-0.3px" }}>LTSU</div>
    <div style={{ fontSize: "14px", color: "var(--text-secondary)", fontWeight: 600 }}>Lamrin Tech Skills University</div>
    <div style={{ fontSize: "12px", color: "#C9A84C", marginTop: "2px", fontWeight: 500, fontStyle: "italic" }}>
        ...
        <span key={t} style={{
          ...
          border:       "1px solid rgba(27,58,107,0.15)",
            ...
            <div style={{ display: "flex", flexWrap: "wrap", gap: "8px" }}>
              ...
              <span style={{ fontSize: "12px", color: "#1B3A6B", fontWeight: 600, padding: "5px 12px" }}>
                +6 more →
              </span>
            </div>
          </motion.div>
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "14px" }}>
              {BADGES.map((badge, i) => (
                ...
                >
                  ...
                  <div style={{ fontSize: "14px", fontWeight: 700, color: "var(--text-primary)", marginBottom: "5px" }}>{badge.title}</div>
                  <div style={{ fontSize: "12px", color: "var(--text-muted)", lineHeight: "1.5" }}>{badge.desc}</div>
                </motion.div>
              ))}
            </div>
