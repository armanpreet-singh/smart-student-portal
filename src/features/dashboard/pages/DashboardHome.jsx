      ...
      <div className="d-grid-main">
        <div className="d-col-8">
          ...
          <SectionHeader
            ...
            action={<button className="d-link-btn">View All</button>}
          />
          ...
          <SectionHeader
            ...
            action={<button className="d-link-btn">Browse All</button>}
          />
        ...
        <div className="d-col-4">
          ...
          />
          <div className="d-list-stack">
            {topAssignments.map((asg) => (
              <AssignmentCard key={asg.id} {...asg} />
            ))}
          </div>
