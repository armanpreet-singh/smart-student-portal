...
export default function Footer({ theme }) {
  ...
  <div>
    ...
    <div style={{ fontSize: "10px", color: "rgba(255,255,255,0.45)", fontWeight: 500, letterSpacing: "0.5px", textTransform: "uppercase" }}>
      University Portal
    </div>
  </div>
</div>
            ...
            <p style={{ fontSize: "13.5px", color: "rgba(255,255,255,0.45)", lineHeight: "1.75", marginBottom: "22px" }}>
              Lamrin Tech Skills University — India's premier tech skills university committed to industry-ready education, innovation, and digital transformation.
            </p>
            ...
            {[
              ...
              <div key={i} style={{ display: "flex", alignItems: "flex-start", gap: "9px", marginBottom: "9px" }}>
                <Icon name={item.icon} size={13} color="rgba(201,168,76,0.6)"
                  style={{ marginTop: "2px", flexShrink: 0 }} />
                <span style={{ fontSize: "13px", color: "rgba(255,255,255,0.42)", lineHeight: "1.5" }}>
                  {item.text}
                </span>
              </div>
            ))}
            ...
            <div style={{ display: "flex", gap: "10px", marginTop: "22px" }}>
              {[
                { icon: "facebook",  href: "https://www.facebook.com/ltsuindia"                            },
                { icon: "twitter",   href: "https://twitter.com/ltsuindia"                                 },
                { icon: "instagram", href: "https://www.instagram.com/ltsuindia"                           },
                { icon: "linkedin",  href: "https://www.linkedin.com/school/lamrin-tech-skills-university" },
        ...
        <div style={{
          ...
          <div style={{ fontSize: "13px", color: "rgba(255,255,255,0.32)" }}>
            © {new Date().getFullYear()} Lamrin Tech Skills University. All rights reserved.
          </div>
